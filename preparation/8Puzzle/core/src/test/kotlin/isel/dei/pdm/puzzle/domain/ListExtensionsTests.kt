...
class ListExtensionsTests {
    ...
    @Test
    fun countInversions_returnsZeroForSortedList() {
        assertEquals(0, listOf(1, 2, 3, 4, 5, 6, 7, 8).countInversions())
    }

    @Test
    fun countInversions_returnsCorrectCountForMixedList() {
        // (2, 1) is 1 inversion
    ...
    @Test
    fun swap_returnsNewListWithSwappedElements() {
    ...
    @Test
    fun swap_returnsSameInstanceIfIndicesAreEqual() {
        val original = listOf(1, 2, 3)
