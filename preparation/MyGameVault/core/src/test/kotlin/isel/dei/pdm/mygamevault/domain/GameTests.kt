...
class GameTests {
    ...
    fun `can create game with string cover uri using convenience constructor`() {
        ...
        // Act
        val game =
            Game(1, "Elden Ring", null, coverUri = coverUriStr, thumbnailUri = null as String?)
    ...
    fun `can create game with string thumbnail uri using convenience constructor`() {
        ...
        // Act
        val game =
            Game(1, "Elden Ring", null, coverUri = null as String?, thumbnailUri = thumbUriStr)
